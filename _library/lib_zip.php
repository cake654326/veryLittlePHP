 ...
 * vpl 
 *
 * 修改自 CodeIgniter zip library
 *
 * @package		cake x
 * @author		goldencake team
 * @since		Version 1.1
 */
...
// echo $this->zipdata;exit();
	...
	function download($filename = 'backup.zip')
	{
		...
		$this->mCore->loadHelp('download');

		$get_zip = $this->get_zip();

		$zip_content =& $get_zip;

		force_download($filename, $zip_content , false);
	}
