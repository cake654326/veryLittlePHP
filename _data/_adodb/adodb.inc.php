...
*/
	...
	function getCxTime()
	{
		...
		return $this->_cx_all_time;
	}
	function setCxTitle($_val)
	{
		$this->_cx_title = $_val;
	}
	function clearCxTitle()
	{
		$this->_cx_title = "No Vallue";
	}
	...
	*/
	...
	{
		if( CXDEBUG == true ){
			$cx_end_time = microtime(true);
			//ChromePhp::log("cx_end_time", $cx_end_time);
...
if (defined('CXDEBUG') )
	...
	* and/or last one of the recordset. Added by Iv嫕 Oliva to provide recordset pagination.
	*
   ...
   /**
	...
	var $_currentPage = -1;	/** Added by Iv嫕 Oliva to implement recordset pagination */
	var $_atFirstPage = false;	/** Added by Iv嫕 Oliva to implement recordset pagination */
	var $_atLastPage = false;	/** Added by Iv嫕 Oliva to implement recordset pagination */
	var $_lastPageNo = -1; 
